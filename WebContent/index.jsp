...
<body>
    ...
    <div id="skills" class="row">
        ...
        <article class="large-12 columns">
            <h2>Skills</h2>
            <h5>Programming : Core Java, Java Swing, C#, C++, C</h5>
            <div class="progress large-9 round">
                <span class="meter" style="width: 100%"></span>
            </div>
            <h5>Web Application: J2EE, Spring, Struts, Hibernate, Ajax, ASP, .Net, XML, HTML, CSS, JavaScript, PHP, jQuery, Foundation, Bootstrap, Mean.io</h5>
    ...
    <div id="education" class="row">
        ...
        <article class="large-12 columns">
            ...
            <p class=MsoNormal style='margin-right:-20.05pt;line-height:115%'>
                ...
                </b>&nbsp;&nbsp;&nbsp;&nbsp;2013<span lang=EN-US style='font-family:"Arial","sans-serif"'>&nbsp;&nbsp;to</span><span lang=EN-US style='font-family:"Arial","sans-serif";'>&nbsp;&nbsp;Apr. 2015</span><b>
                </b>
            </p>
